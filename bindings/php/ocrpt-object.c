...
void register_opencreport_ce(void) {
	...
	REGISTER_OPENCREPORT_CLASS_CONST_LONG("VARREF_MVAR", OCRPT_VARREF_MVAR);
	REGISTER_OPENCREPORT_CLASS_CONST_LONG("VARREF_RVAR", OCRPT_VARREF_RVAR);
	REGISTER_OPENCREPORT_CLASS_CONST_LONG("VARREF_IDENT", OCRPT_VARREF_IDENT);
	REGISTER_OPENCREPORT_CLASS_CONST_LONG("VARREF_VVAR", OCRPT_VARREF_VVAR);
}
