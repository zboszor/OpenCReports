...
if test "$PHP_OPENCREPORTS" != "no"; then
	...
	PHP_NEW_EXTENSION(opencreports, [opencreport.c ocrptinit.c rlibcompat.c ocrpt-object.c ds-object.c query-object.c qresult-object.c expr-object.c eresult-object.c part-object.c row-object.c], $ext_shared)
