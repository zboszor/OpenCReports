...
int main(int argc, char **argv) {
	...
	ocrpt_datasource *ds = ocrpt_datasource_add(o, "csv", "csv", NULL);
	ocrpt_datasource *ds2 = ocrpt_datasource_add(o, "array", "array", NULL);
	ocrpt_query *q, *q2;
	...
	q = ocrpt_query_add_file(ds, "a", "csvquery.csv", coltypes, COLS);
