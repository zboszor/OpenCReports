...
int main(void) {
	...
	ocrpt_text_set_value_expr(t, "printf('Page header: %d / %d', r.pageno, r.totpages)", false);
	...
	ocrpt_text_set_value_expr(t, "printf('Page footer: %d / %d', r.pageno, r.totpages)", false);
	ocrpt_text_set_alignment(t, "'right'");
