...
int main(int argc, char **argv) {
	...
	ocrpt_variable_new(r, OCRPT_VARIABLE_AVERAGE, "var3", "age", "age > 0.9*v.var1", "br1", true);
	ocrpt_variable_new(r, OCRPT_VARIABLE_AVERAGE, "var4", "age", "age > 0.9*v.var1", NULL, true);
