...
/* Extra query for GeneratedLine field headers:
 * label = column header text, col_width = width in chars,
 * element_type = GeneratedLine element type */
const char *header_array[6][3] = {
	{ "label", "col_width", "element_type" },
	{ "ID", "5", "text" },
	{ "Name", "21", "text" },
	{ "Property", "11", "text" },
	{ "Age", "7", "text" },
...
const int32_t header_coltypes[3] = {
	OCRPT_RESULT_STRING, OCRPT_RESULT_NUMBER, OCRPT_RESULT_STRING
};
...
int main(int argc, char **argv) {
	...
	ocrpt_query *h = ocrpt_query_add_data(ds, "h", (const char **)header_array, 5, 3, header_coltypes, 3);
