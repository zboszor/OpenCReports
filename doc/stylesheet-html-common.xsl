...
<xsl:param name="link.mailto.url">zboszor@gmail.com</xsl:param>
...
<xsl:template name="generate-basic-index">
  ...
  <!-- ocrpt-docs: added xmlns:xlink, autoidx.xsl doesn't include xlink in
