...
static void ocrpt_xml_start_data_row(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *l, double page_indent, double y) {
}

static void ocrpt_xml_end_data_row(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *l) {
}

static void ocrpt_xml_draw_text(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *l, ocrpt_text *le, double page_width, double page_indent, double y) {
	if (le->value || le->result_str->len)
		fprintf(stderr, "ocrpt_xml_draw_text: %s\n", le->result_str->str);
}

static void ocrpt_xml_draw_image(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *line, ocrpt_image *img, double page_width, double page_indent, double x, double y, double w, double h) {
	fprintf(stderr, "ocrpt_xml_draw_image: -\n");
}
...
void ocrpt_xml_init(opencreport *o) {
	...
	o->output_functions.end_data_row = ocrpt_xml_end_data_row;
