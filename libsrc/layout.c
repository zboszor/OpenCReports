...
static void ocrpt_layout_line_get_text_sizes(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *line, double page_width, double *page_position) {
	...
	for (ocrpt_list *l = line->elements; l; l = l->next) {
		...
		case OCRPT_OUTPUT_LE_TEXT:
			elem->suppress_text = EXPR_VALID_NUMERIC(elem->suppress) && !!mpfr_get_si(EXPR_NUMERIC(elem->suppress), EXPR_RNDMODE(elem->suppress));
			if (elem->suppress_text)
				break;
...
static void ocrpt_layout_image_setup(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_column *pd, ocrpt_report *r, ocrpt_output *output, ocrpt_line *line, ocrpt_image *image, double page_width, double page_indent, double *page_position) {
	...
	if (EXPR_VALID_NUMERIC(image->suppress) && !!mpfr_get_si(EXPR_NUMERIC(image->suppress), EXPR_RNDMODE(image->suppress))) {
...
void ocrpt_layout_output_evaluate_expr_params(ocrpt_output *output) {
	for (ocrpt_list *ol = output->output_list; ol; ol = ol->next) {
		...
		ocrpt_barcode *lbc = (ocrpt_barcode *)oe;
...
static void ocrpt_layout_output_resolve_text(ocrpt_text *elem) {
	...
	ocrpt_expr_resolve(elem->suppress);
	ocrpt_expr_optimize(elem->suppress);
			...
			if (!((ocrpt_genline *)oe)->resolved) {
				...
				while (ocrpt_query_navigate_next(gl->query)) {
					...
					if (is_text) {
						...
						e = ocrpt_text_set_suppress(text, ocrpt_expr_string_wrap_eval(output, gl->suppress, tmpstr));
						ocrpt_expr_resolve_from_query(e, gl->query);
						ocrpt_expr_constify(e, gl->query);
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_value(ocrpt_genline *gl) GET_GENLINE_EXPR(value)
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_set_value_delayed(ocrpt_genline *gl, const char *expr_string) SET_GENLINE_EXPR(delayed, true, false)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_height(ocrpt_genline *gl) GET_GENLINE_EXPR(height)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_alignment(ocrpt_genline *gl) GET_GENLINE_EXPR(align)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_color(ocrpt_genline *gl) GET_GENLINE_EXPR(color)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_bgcolor(ocrpt_genline *gl) GET_GENLINE_EXPR(bgcolor)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_font_name(ocrpt_genline *gl) GET_GENLINE_EXPR(font_name)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_font_size(ocrpt_genline *gl) GET_GENLINE_EXPR(font_size)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_bold(ocrpt_genline *gl) GET_GENLINE_EXPR(bold)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_italic(ocrpt_genline *gl) GET_GENLINE_EXPR(italic)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_format(ocrpt_genline *gl) GET_GENLINE_EXPR(format)
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_set_link(ocrpt_genline *gl, const char *expr_string) SET_GENLINE_EXPR(link, true, true)
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_link(ocrpt_genline *gl) GET_GENLINE_EXPR(link)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_translate(ocrpt_genline *gl) GET_GENLINE_EXPR(translate)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_memo(ocrpt_genline *gl) GET_GENLINE_EXPR(memo)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_hyphenate(ocrpt_genline *gl) GET_GENLINE_EXPR(hyphenate)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_wrap_chars(ocrpt_genline *gl) GET_GENLINE_EXPR(wrap_chars)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_max_lines(ocrpt_genline *gl) GET_GENLINE_EXPR(max_lines)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_image_type(ocrpt_genline *gl) GET_GENLINE_EXPR(imgtype)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_text_width(ocrpt_genline *gl) GET_GENLINE_EXPR(text_width)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_genline_get_barcode_type(ocrpt_genline *gl) GET_GENLINE_EXPR(bctype)
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_text_set_suppress(ocrpt_text *text, const char *expr_string) {
	SET_TEXT_EXPR(suppress, true, false);
}

DLL_EXPORT_SYM ocrpt_expr *ocrpt_text_get_suppress(ocrpt_text *text) {
	GET_TEXT_EXPR(suppress);
}
...
DLL_EXPORT_SYM ocrpt_expr *ocrpt_report_set_fielddetail_row_match(ocrpt_report *r, const char *expr_string) {
	if (!r || (r->o && r->o->executing))
		return NULL; \

	ocrpt_expr_free(r->fielddetail_row_match);

	r->fielddetail_row_match = expr_string ? ocrpt_report_expr_parse(r, expr_string, NULL) : NULL;

	return r->fielddetail_row_match;
}

DLL_EXPORT_SYM ocrpt_expr *ocrpt_report_get_fielddetail_row_match(ocrpt_report *r) {
