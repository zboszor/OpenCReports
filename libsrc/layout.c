...
void ocrpt_layout_output(opencreport *o, ocrpt_part *p, ocrpt_part_row *pr, ocrpt_part_row_data *pd, ocrpt_report *r, ocrpt_output *output, unsigned int rows, bool *newpage, double *page_indent, double *page_position) {
	...
	ocrpt_layout_output_internal(false, o, p, pr, pd, r, output, r->column_width, *page_indent, &new_page_position);
	...
	if (!o->precalculate) {
		...
		ocrpt_layout_output_internal(true, o, p, pr, pd, r, output, r->column_width, *page_indent, &new_page_position);
	}
